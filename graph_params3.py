...
f = open(dir + '/output' + '/O' + str(dir1) + '/' + str(dir2) +  '/orig_path.txt', 'r')
for l in f:
   l = l.strip().split(' ')
   enclaves.add(l[0])
...
new_ = open(dir + '/output/O' + str(dir1) + '/' + str(dir2) + '/orig.txt' , 'w')
new_sif = open(dir + '/output/O' + str(dir1) + '/' + str(dir2) + '/orig.sif' , 'w')
...
new_ = open(dir + '/output/O' + str(dir1) + '/' + str(dir2) + '/new.txt' , 'w')
new_sif = open(dir + '/output/O' + str(dir1) + '/' + str(dir2) + '/new.sif' , 'w')
new_.write(str(len(nodes)) + " " + str(len(edges)) + "\n")
