...
class ConstraintBuilder():
    def __init__(self, vertices, enclaves, correlations, distances, variable_holder, dir, obj, rd):
        self.v = vertices
        self.e = enclaves
        self.c = correlations
        self.d = distances
            ...
            while len(adj_list) > 0:
                ...
                if len(s.children) == 0:
                  ...
                  #              continue
                            ...
                            #if s_no == 24 or s_no == 3 or s_no == 84 or s_no == 63 or s_no == 45:
                            #    continue
                            ...
                            #    continue
                            #bics
#                            if s_no == 83 or s_no == 23 or s_no == 46 or s_no == 3 or s_no == 66 or s_no == 107 or s_no == 108:
#                                continue
