...
class objBuilder():
    def __init__(self, vertices, variableHolder, distances, correlations, path, sr):
...
class ConstraintBuilder():
    def __init__(self, vertices, enclaves, correlations, distances, variable_holder, dir, obj, rd, no_trees, src_tree):
        self.v = vertices
        self.e = enclaves
        self.c = correlations
        self.d = distances
...
#                     self.obj.coeffs.append(15)
    ...
    def covarianceTreeConstraints2(self):
        ...
        fil = open(self.path + "/" + self.src + '/correlations.txt' , 'r')
        for line in fil:
