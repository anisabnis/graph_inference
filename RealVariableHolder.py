...
class binaryVariable(Variable):
    def __init__(self, name):
        Variable.__init__(self, name, 0, 1, "real")
...
class VariableHolder():
    ...
    def getVariable(self, type, name, lb = 0, ub = 1):
        ...
        elif type == 'a' or type == 'b' or type == 'w' or type == 'q' or type == "s" or type == "d" or type == "q" or type == 'm' or type == 'v' or type == 'l' or type == 'e' or type == 'x': 
            v = binaryVariable(name)
            self.variables[name] = v
            return v

        
        elif type == 'e' or type == 'f':
            v = intVariable(name, lb, ub)
            self.variables[name] = v
            return v

        elif type == 's' or type == 'r' or type=='n'  or type== 'k' or type=='i' or type == 'j'  or type == 'm' or type == 'p' or type == 'rn' or type == 'rb' or type == 'ra' or type == 'z' or type == 'x' or type == 'e':
            v = intVariable(name, lb, ub)
            self.variables[name] = v
            return v

 #       elif type == 's' or type == 'x' or type == 'z' or type == 'k' or type == 'e' or type == 'p':
        elif type == 'w' or type == 'z' or type == 'e':
