...
f = open(dir + '/output' + '/' + str(dir1)  +  '/orig_path.txt', 'r')
for l in f:
   l = l.strip().split(' ')
   enclaves.add(l[0])
...
new_ = open(dir + '/output/' + str(dir1) + '/orig.txt' , 'w')
new_sif = open(dir + '/output/' + str(dir1) + '/orig.sif' , 'w')
...
new_ = open(dir + '/output/' + str(dir1)  + '/new.txt' , 'w')
new_sif = open(dir + '/output/' + str(dir1) + '/new.sif' , 'w')
new_.write(str(len(nodes)) + " " + str(len(edges)) + "\n")
