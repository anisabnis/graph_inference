...
scp -2 asabnis@ct1.h6e-t1a.edgect.isi.deterlab.net:~/cplex/bin/x86-64_linux/solution.xml results_psm_dist/$dir/res$enc.xml

python3.6 parsetrees.py results_psm_dist/$dir/ $enc
python3.6 parse_solution.py results_psm_dist/$dir/ 

python3.6 gen_dot1.py results_psm_dist/$dir/
